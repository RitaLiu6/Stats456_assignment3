...
> In my model, boosting is contributing the most.  
...
> For quantitative data, I can give them a range to choose from, probably using sliderInput(). For categorical data, I probably will give them options by using selectInput(). 
...
> I will probably choose the mean of each variable. 
